...
int main() {
	...
	if (loadScene) {
		...
		// new shader
		Shader::Sptr newShader = ResourceManager::CreateAsset<Shader>(std::unordered_map<ShaderPartType, std::string>{
			{ ShaderPartType::Vertex, "shaders/vertex_shader.glsl" },
			{ ShaderPartType::Fragment, "shaders/frag_shininess_reflective.glsl" }
		});

		MeshResource::Sptr monkeyMesh = ResourceManager::CreateAsset<MeshResource>("Monkey.obj");
		Texture2D::Sptr    boxTexture = ResourceManager::CreateAsset<Texture2D>("textures/box-diffuse.png");
		//MeshResource::Sptr boxMesh = ResourceManager::CreateAsset< MeshBuilderParam
		...
		Material::Sptr boxMaterial = ResourceManager::CreateAsset<Material>();
		{
			...
			boxMaterial->MatShader = newShader; 
			boxMaterial->Texture = boxTexture;
			boxMaterial->SpecularTexture = ResourceManager::CreateAsset<Texture2D>("textures/box-specular.png");
		...
		{
			// Make a big tiled mesh
			MeshResource::Sptr bMesh = ResourceManager::CreateAsset<MeshResource>();
			bMesh->AddParam(MeshBuilderParam::CreateCube(glm::vec3(0,0,0), glm::vec3(1,1,1)));
			bMesh->GenerateMesh();
