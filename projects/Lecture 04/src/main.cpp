...
bool initGLFW() {
	...
	window = glfwCreateWindow(800, 800, "Abdalla Mohamed-100795120", nullptr, nullptr);
...
int main() {
	...
	glm::mat4 View = glm::lookAt(glm::vec3(0.0f, 0.0f, 4.0f), //camera position
		glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f,1.0f,0.0f)); //target and up vector
