...
bool initGLFW() {
	...
	window = glfwCreateWindow(800, 800, "Texture Filtering - Lecture 9 - Abdalla Mohamed,100795120", nullptr, nullptr);
...
int main() {
	...
	glTextureParameterf(GL_TEXTURE_2D, GL_TEXTURE_MAX_ANISOTROPY, 16.0f);
